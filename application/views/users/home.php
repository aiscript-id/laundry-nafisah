      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-4">
            <div class="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3">
              <div class="features-icons-icon d-flex mb-2">
                <img src="<?=base_url('assets/users/')?>img/svg/washing-machine.png" class="h-100 mx-auto">
              </div>
          ...
          <div class="col-lg-4">
            <div class="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3">
              <div class="features-icons-icon d-flex mb-2">
                <img src="<?=base_url('assets/users/')?>img/svg/towel.png" class="h-100 mx-auto">
              </div>
              <h3>Pakaian Rapi</h3>
          ...
          <div class="col-lg-4">
            <div class="features-icons-item mx-auto mb-0 mb-lg-3">
              <div class="features-icons-icon d-flex mb-2">
                <img src="<?=base_url('assets/users/')?>img/svg/brightening.png" class="h-100 mx-auto">
              </div>
              <h3>Pakaian Wangi</h3>
